        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col gap-1">
            ...
            <input
              ...
              style={{ backgroundColor: "transparent", border: "1px solid rgba(128,128,128,0.3)", color: "var(--foreground)" }}
          ...
          <button
            ...
            style={{ backgroundColor: "var(--accent-neon)", color: "#0d1317", opacity: loading ? 0.6 : 1, cursor: loading ? "wait" : "pointer" }}
          >
